...
<body>
	<center>
		<h1><font color="red">添加商品</font></h1>
		<s:form action="manager_insert_goods_action" method="post" enctype="multipart/form-data" onSubmit="return validate()">
		<s:textfield name = "goods.number" label = "商品编号"/>
		<s:textfield name = "goods.name" label = "商品名字"/>
		<s:textfield name = "goods.price" label = "商品价格"/>
		<s:textfield name = "goods.amount" label = "商品数量"/>
		<sx:datetimepicker name = "goods.publishDate" label="发布日期" displayFormat="yyyy-MM-dd" />
