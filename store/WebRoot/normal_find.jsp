...
<h2>商品的信息</h2>
	<table border="1" width="80%">
		...
		<tr>
			...
			<th><a
				href="<s:url action="normal_insert_buycar"><s:param name="number" value="goods.number"></s:param> </s:url>">添加到购物车</a>
			</th>
		</tr>
	</table>
	<br />
